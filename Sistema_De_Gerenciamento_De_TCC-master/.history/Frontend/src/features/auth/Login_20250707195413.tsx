      ...
      <div className="bg-[#FDF2BF] w-[90%] max-w-[400px] md:max-w-[500px] lg:max-w-[600px] rounded-lg shadow-lg flex flex-col mt-1 p-1 px-4">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col mt-3 font-sans font-semibold">
          ...
          <div className='relative items-center mb-2'>
            ...
            {/* Toggle senha visível/invisível */}
            <span
              ...
              tabIndex={0}
              onKeyPress={e => {
                if (e.key === "Enter" || e.key === " ") toggleSenha();
              }}
            >
          ...
          <Link
            to="/"
            className='flex items-center justify-center text-blue-900 font-semibold hover:opacity-45 mb-3'
          >
            Esqueci a senha
          </Link>
          ...
          <div className="flex mx-auto items-center justify-center mt-4">
            <Button type="submit" bgColor="bg-[#0F2C67]" width="w-72" height='h-11'>
              Entrar
            </Button>
          </div>
          ...
          <div className='flex flex-col items-center justify-center mt-3'>
            ...
            <Link to="/register" className='text-blue-900 font-bold hover:opacity-45'>
              Cadastre-se
            </Link>
          </div>
        </form>
