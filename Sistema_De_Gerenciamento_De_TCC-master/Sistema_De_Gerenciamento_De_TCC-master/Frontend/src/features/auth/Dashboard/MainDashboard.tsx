      ...
      <div className="flex flex-col items-center bg-[#F3C50D] h-screen overflow-x-hidden w-screen pt-6">
        ...
        <div className="w-[85%] h-[40%] bg-[#fffbef] flex flex-col rounded-lg shadow-lg p-6 pt-1 px-auto">
          ...
          <div className="flex flex-col items-start gap-2">
            ...
            <h1 className=" flex  items-center gap-2 text-2xl font-sans font-medium text-[#252525]">   <IoPersonOutline />
              Aluno: {aluno} • {curso}
            </h1>

            <h1 className=" flex items-center gap-2 text-2xl font-sans font-normal text-[#252525]"> <IoBookOutline />
              Orientador: {orientador}
            </h1>

            <h1 className=" flex items-center gap-2 text-2xl font-sans font-normal text-[#252525]"> <FaUserFriends />
        ...
        <div className='w-[85%] flex flex-col mt-4'>
          <div className=' flex flex-row items-center text-2xl gap-28 pl-8 bg-[#fffbef] w-full min-h-20 mt-4 rounded-sm shadow-lg'>            
          ...
          {/* Container to align the marks and schedule side by side  */}
           <div className='flex flex-row gap-4'>

          

            {/* container marks */}
            <div className=' flex flex-col w-[65%] bg-[#fffbef] min-h-60 mt-4 rounded-lg shadow-lg p-6 mb-5'>

            </div>
          

            
            {/* container to align the schedule and quick action bellow one of the other bellow*/}
            <div className=' flex flex-col w-[35%]'>
               
               {/* container schedule */}
              <div className=' flex  bg-[#fffbef] min-h-72 mt-4 rounded-lg shadow-lg mb-1 p-6'>
                <h1 className='text-3xl text-center font-bold'>Cronograma</h1>
                </div>
                
                {/* container quick action*/}
                <div className='flex  bg-[#fffbef]  min-h-80 mt-4 rounded-lg shadow-lg mb-5 p-6'>
