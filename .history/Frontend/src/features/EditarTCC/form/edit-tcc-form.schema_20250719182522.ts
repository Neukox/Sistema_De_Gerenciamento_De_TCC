...
/**
 * Schema de validação para o formulário de edição de TCC.
 * Utiliza a biblioteca Zod para definir as regras de validação.
 */
export const editTCCFormSchema = z
  .object({
...
export type EditTCCFormData = z.infer<typeof editTCCFormSchema>;
export default editTCCFormSchema;
