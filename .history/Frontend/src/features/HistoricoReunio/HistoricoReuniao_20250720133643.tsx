    ...
    <div className="min-h-screen bg-yellow-400 flex justify-center items-start py-10 px-4">
      <div className="bg-white max-w-2xl w-full rounded-xl p-6 space-y-6 shadow-md">
        ...
        <div className="space-y-4">
          {/* Log visual para depuração do tipo e valor bruto */}
          <div className="bg-gray-100 p-2 mb-2 rounded text-xs text-black">
            <strong>Tipo de reunioes:</strong> {typeof reunioes}<br />
            <strong>Valor bruto:</strong> {String(reunioes)}
          </div>
          {loading ? (
            ...
            <>
              <div className="text-center text-red-500">Erro: O formato das reuniões está incorreto.</div>
