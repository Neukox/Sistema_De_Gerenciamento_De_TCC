...
export function AgendarReuniao() {
  ...
  const { atualizarReunioes } = useReunioes();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (reuniao) {
      ...
      // Atualiza contexto global de reuniões
      await atualizarReunioes();
      // Redireciona para o histórico de reuniões
      navigate("/historico-reunioes");
    }
  };
