  ...
  <div className="flex items-center justify-between h-[25%] bg-red-50 p-4 rounded shadow-sm">
    <div className="flex items-center gap-2 -mt-[5%]">
      ...
      <h2 className="font-semibold text-gray-800">Tarefa Criada</h2>
        ...
        <svg w-6 h-6 xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-blue-500" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
  <path strokeLinecap="round" strokeLinejoin="round" d="M9 2.25h6m-6 0a2.25 2.25 0 00-2.25 2.25v.75h10.5v-.75A2.25 2.25 0 0015 2.25m-6 0h6m-9 6h12M9 12h6m-6 4h6" />
</svg>
