      ...
      <div className="bg-white w-full max-w-3xl rounded-3xl p-6 sm:p-10 shadow-xl">
        ...
        <form>
          ...
          <div className="mb-6">
            ...
            <textarea
              id="descricao"
              className="px-3 w-[100%] h-[50%] py-2 focus:outline-none focus:ring-2 focus:ring-gray-300 rounded-lg border border-solid border-gray-400 bg-gray-200 font-normal"
