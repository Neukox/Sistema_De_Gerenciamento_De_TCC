            ...
            <div className="bg-white w-[35%] h-[1100px] m-10 rounded-3xl">
                ...
                <form action="">
                    ...
                    <div>
                        <button
                            type="submit"
                            className="w-[80%] h-12 ml-10 mt-10 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 mt-10">
