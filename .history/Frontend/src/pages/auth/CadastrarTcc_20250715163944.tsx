...
export function CadastrarTcc() {
  return (
    <div className="bg-secondary w-screen flex justify-center items-start h-[3000px]">
      <div className="bg-white w-[500px] h-[2000px] mt-10 rounded-2xl">
              ...
              <div>
                ...
                <div>
                    ...
                    <input
                        ...
                        id="data-inicio"
                        className="border-2 border-gray-300 rounded-lg w-[400px] h-[50px] ml-10 mt-2 px-3"
                        placeholder="Selecione a data de início do seu TCC"
                    />
                </div>

                {/* Data de Conclusão */}
                <div>
                    <label className='flex mt-10 ml-10' htmlFor="Data de conclusão">Data de conclusão</label>
                    <input
                        type="date"
                        id="data-conclusao"
                        className="border-2 border-gray-300 rounded-lg w-[400px] h-[50px] ml-10 mt-2 px-3"
                        placeholder="Selecione a data de conclusão do seu TCC"
                    />
                </div>

                {/* Status Atual */}
                <div>
                    <label className='flex mt-10 ml-10' htmlFor="Status atual">Status Atual</label>
                    <select
                        id="status-atual"
                        name="statusAtual"
                        className="border-2 border-gray-300 rounded-lg w-[400px] h-[50px] ml-10 mt-2 px-3">
                        <option value="EM_ANDAMENTO">Planejamento</option>
                        <option value="CONCLUIDO">Desenvolvimento</option>
