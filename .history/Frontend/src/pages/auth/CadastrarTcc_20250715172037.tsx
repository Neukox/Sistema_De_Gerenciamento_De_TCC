...
export function CadastrarTcc() {
  return (
    <div className="bg-secondary w-screen flex justify-center items-start h-[2500px]">
      <div className="bg-white w-[500px] h-[1800px] mt-10 rounded-2xl">
          ...
          <form action="">
            <div>
              ...
              <div>
                ...
                <textarea
                  id="resumo"
                  className=" w-[400px] h-[100px] ml-10 mt-2 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-300 rounded-lg border border-solid border-gray-400 bg-gray-200 font-normal"
