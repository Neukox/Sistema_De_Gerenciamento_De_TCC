            ...
            <div>
              ...
              <div>
                ...
                <select
                  ...
                  className=" ml-10 w-[300px]px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-300 rounded-lg border border-solid border-gray-400 bg-gray-200 font-normal"
                >
