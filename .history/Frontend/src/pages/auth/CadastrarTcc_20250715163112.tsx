          ...
          <form action="">
            <div>
              ...
              <div>
                ...
                {/* Curso */}
                <div>
                    <label className='flex ml-10 mt-10' htmlFor="Curso">Curso</label>
                    <input
                      type="text"
                      id="curso"
                      className="border-2 border-gray-300 rounded-lg w-[400px] h-[50px] ml-10 mt-2 px-3"
                ...
                {/* Orientador */}
                <div>
                    <label className='flex ml-10 mt-10' htmlFor="orientador">Orientador</label>
                    <input
                      type="text"
                      id="orientador"
                      className="border-2 border-gray-300 rounded-lg w-[400px] h-[50px] ml-10 mt-2 px-3"
                ...
                {/* Coorientador */}
                <div>
                    <label className='flex ml-10 mt-10' htmlFor="coorientador">Coorientador</label>
                    <input
                      type="text"
                      id="coorientador"
                      className="border-2 border-gray-300 rounded-lg w-[400px] h-[50px] ml-10 mt-2 px-3"
