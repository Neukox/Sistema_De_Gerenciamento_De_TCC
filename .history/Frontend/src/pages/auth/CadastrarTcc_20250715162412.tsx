                ...
                <div>
                    <form action="">
                        <div>
                            ...
                            <div>
                                <label htmlFor="Area do Conhecimento">Área do Conhecimento</label>
                                <select
                                    className="border-2 border-gray-300 rounded-lg w-[400px] h-[50px] ml-10 mt-2 px-3"
                                    name="Area do Conhecimento"
                                ...
                                >
                                    ...
                                    <option value="Area 4">Área 4</option>
                                    <option value="Area 5">Área 5</option>
                                </select>
                            </div>
                        </div>
                    </form>
