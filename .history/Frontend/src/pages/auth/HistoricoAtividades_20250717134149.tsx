...
>
  ...
  <option value="sistema">Sistema</option>
        ...
        <div>
            <h1 className="flex font-semibold ml-10 text-2xl">Atividades Recentes</h1>
        </div>

        <div className="flex items-center justify-between h-[15%] bg-red-50 p-4 rounded shadow-sm">
            <div className="flex items-center gap-4">
                ...
                >
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M12 9v3m0 0v3m0-3h3m-3 0H9m9.75 6.75a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"
                    />
                </svg>
                </div>
                <div>
                <h2 className="font-semibold">Nome da Atividade</h2>
                <p className="text-gray-500">Descrição breve da atividade.</p>
                </div>
            </div>
