...
<div className="bg-historicoatividades w-full h-full max-w-6xl p-6 rounded-2xl flex flex-col gap-4">
 ...
 <div className="flex items-center justify-between h-[25%] bg-red-50 p-4 rounded shadow-sm">
  ...
  <div className="flex items-center gap-2 -mt-[5%]">
    ...
    {/* 
      Antes o título "Tarefa Criada" estava sozinho assim:
      <h2 className="font-semibold text-gray-800">Tarefa Criada</h2>

      E os <p> estavam em outra div com margens negativas: 
      <div className="flex flex-col">
        <p className="flex mt-[20%] -ml-[45%]">Criou a tarefa "Desenvolvimento de introdução do TCC."</p>
        <p className="flex mt-[20%] -ml-[45%]">Data: 12/03/2023</p>
      </div>

      Isso fazia os textos ficarem deslocados para baixo e para a esquerda, fora do alinhamento.
    */}

    {/* Agora título + textos ficam juntos em coluna alinhada */}
    <div className="flex flex-col">
      {/* Título */}
      <h2 className="font-semibold text-gray-800">Tarefa Criada</h2>

      {/* Textos abaixo do título, um abaixo do outro, sem margens negativas */}
      <p className="text-sm text-gray-600">Criou a tarefa "Desenvolvimento de introdução do TCC."</p>
      <p className="text-sm text-gray-600">Data: 12/03/2023</p>
    </div>
  </div>

  {/* 
    Antes os ícones extras estavam juntos com o título e os textos, 
    mas aqui estão organizados em uma div separada, alinhados à direita.
  */}
  <div className="flex items-center gap-2">
    <svg className="w-6 h-6 text-blue-400" xmlns="http://www.w3.org/2000/svg" fill="none"
      viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round"
        d="M6 6.878V6a2.25 2.25 0 0 1 2.25-2.25h7.5A2.25 2.25 0 0 1 18 6v.878m-12 0c.235-.083.487-.128.75-.128h10.5c.263 0 .515.045.75.128m-12 0A2.25 2.25 0 0 0 4.5 9v.878m13.5-3A2.25 2.25 0 0 1 19.5 9v.878m0 0a2.246 2.246 0 0 0-.75-.128H5.25c-.263 0-.515.045-.75.128m15 0A2.25 2.25 0 0 1 21 12v6a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 18v-6c0-.98.626-1.813 1.5-2.122" />
    </svg>

    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-green-500" fill="none"
      viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round"
