export function HistoricoAtividades() {
  return (
    <div className="flex flex-col items-center justify-start h-[2000px] bg-historico px-6 py-8 gap-4">
...
<div className="bg-historicoatividades w-full h-full max-w-6xl p-6 rounded-2xl flex flex-col gap-6">
  ...
  <div className="flex items-center justify-between bg-red-50 p-4 rounded shadow-sm">
    ...
    <div className="flex items-center gap-2">
      ...
      <svg className="w-10 h-10 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none"
        viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round"
          d="M9 12l2 2 4-4" />
      </svg>
  ...
  {/* Ações em Tarefas */}
  <div className="flex flex-col items-center bg-white rounded-2xl p-6 shadow-md w-48">
    <svg className="w-12 h-12 text-green-600 mb-3" fill="none" stroke="currentColor" strokeWidth="1.5" 
      viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75"/>
      <circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="1.5" fill="none"/>
    </svg>
    <h3 className="font-semibold text-lg mb-1">Ações em Tarefas</h3>
    <p className="text-3xl font-bold text-gray-800">25</p>
  </div>

  {/* Marcos Atingidos */}
  <div className="flex flex-col items-center bg-white rounded-2xl p-6 shadow-md w-48">
    <svg className="w-12 h-12 text-blue-600 mb-3" fill="none" stroke="currentColor" strokeWidth="1.5" 
      viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v8m4-4H8" />
    </svg>
    <h3 className="font-semibold text-lg mb-1">Marcos Atingidos</h3>
    <p className="text-3xl font-bold text-gray-800">12</p>
  </div>

  {/* Notas Criadas */}
  <div className="flex flex-col items-center bg-white rounded-2xl p-6 shadow-md w-48">
    <svg className="w-12 h-12 text-yellow-600 mb-3" fill="none" stroke="currentColor" strokeWidth="1.5" 
      viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6M7 20h10a2 2 0 002-2V6a2 2 0 00-2-2H7a2 2 0 00-2 2v12a2 2 0 002 2z" />
    </svg>
    <h3 className="font-semibold text-lg mb-1">Notas Criadas</h3>
    <p className="text-3xl font-bold text-gray-800">8</p>
  </div>

  {/* Configurações */}
  <div className="flex flex-col items-center bg-white rounded-2xl p-6 shadow-md w-48">
    <svg className="w-12 h-12 text-gray-700 mb-3" fill="none" stroke="currentColor" strokeWidth="1.5" 
      viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
    </svg>
    <h3 className="font-semibold text-lg mb-1">Configurações</h3>
