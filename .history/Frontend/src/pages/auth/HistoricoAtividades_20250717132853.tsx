export function HistoricoAtividades() {
  return (
   ...
   <div className="flex items-center w-[50%] bg-white text-gray-500 rounded px-4 py-2 shadow-sm gap-2">
  <svg
  ...
  />
        ...
        <option className="bg-white text-black px-4 py-2 rounded border border-gray-300 shadow-sm"  value="">
            Todos os tipos
