  ...
  return (
    <div className="flex flex-col items-center justify-start h-screen bg-historico px-6 py-8 gap-4">
      ...
      <div className="bg-historicoatividades w-full max-w-6xl p-4 rounded-2xl flex items-center gap-4">
        ...
        <span <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
        </svg>
        
        
        className="flex items-center w-[50%] bg-white text-gray-500 rounded px-4 py-2 shadow-sm">
          Buscar no histórico...
        </span>

        {/* Botões simulado */}
        <button className="bg-white text-black px-4 py-2 rounded border border-gray-300 shadow-sm">
          Todos os tipos
        </button>
        <button className="bg-white text-black px-4 py-2 rounded border border-gray-300 shadow-sm">
          Todas as datas
