        ...
        <div className="flex items-center justify-center h-screen bg-historico">
            <div className="bg-historicoatividades w-screen h-[15%] m-[3%] rounded-2xl -mt-[35%]">
                <div>
                    ...
                    <div>
                        <butt <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 13.5 12 21m0 0-7.5-7.5M12 21V3" />
                        </svg>

                        
                        className="bg-red-300 ml-[85%] -mt-[2%] flex w-[9%] h-[45px] justify-center items-center">Exportar</butt
