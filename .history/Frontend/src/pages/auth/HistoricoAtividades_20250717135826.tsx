export function HistoricoAtividades() {
  return (
    <div className="flex flex-col items-center justify-start h-screen bg-historico px-6 py-8 gap-4">
      ...
      {/* Seção de Atividades */}
      <div className="bg-historicoatividades w-full max-w-6xl p-6 rounded-2xl flex flex-col gap-4">
        <h1 className="font-semibold text-2xl ml-3">Atividades Recentes</h1>

        {/* Item de atividade */}
        <div className="flex items-start gap-6 bg-red-50 p-4 rounded shadow-sm">
          {/* Coluna de ícones e título */}
          <div className="flex flex-col items-start gap-2 min-w-fit">
            ...
            <div className="flex gap-2">
              <svg className="w-6 h-6 text-blue-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
