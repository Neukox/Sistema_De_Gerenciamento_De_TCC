...
<div className="bg-historicoatividades w-full h-full max-w-6xl p-6 rounded-2xl flex flex-col gap-4">
  ...
  <div className="flex items-center gap-4 bg-red-50 p-4 rounded shadow-sm">
    <svg className="w-6 h-6 text-green-600" xmlns="http://www.w3.org/2000/svg" fill="none"
      ...
      <path strokeLinecap="round" strokeLinejoin="round"
        ...
        3.745 3.745 0 0 1-3.296 1.043A3.745 3.745 0 0 1 12 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 0 1-3.296-1.043 
        3.745 3.745 0 0 1-1.043-3.296A3.745 3.745 0 0 1 3 12c0-1.268.63-2.39 
        1.593-3.068a3.745 3.745 0 0 1 1.043-3.296 3.746 3.746 0 0 1 
        3.296-1.043A3.746 3.746 0 0 1 12 3c1.268 0 2.39.63 
        3.068 1.593a3.746 3.746 0 0 1 3.296 1.043 3.746 3.746 0 0 1 
        1.043 3.296A3.745 3.745 0 0 1 21 12Z" />
    </svg>
    <h2 className="font-semibold text-lg text-gray-800">Tarefa Criada</h2>
  </div>

  {/* Atividade: Atividade Concluída */}
  <div className="flex items-center gap-4 bg-green-50 p-4 rounded shadow-sm">
    <svg className="w-6 h-6 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none"
      viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round"
        d="M5 13l4 4L19 7" />
    </svg>
    <h2 className="font-semibold text-lg text-gray-800">Atividade Concluída</h2>
  </div>
</div>
