    ...
    try {
      ...
      if (userData) {
        ...
        try {
          ...
          console.log('Resposta COMPLETA do TCC:', JSON.stringify(tccResponse, null, 2));
          ...
          console.error('Erro específico ao buscar TCC:', tccError);
          // TCC error, usar dados padrão
          setTccData({
            title: 'Erro ao Carregar TCC',
            aluno: userData.nome_completo,
            curso: userData.role === 'ALUNO' ? 'Ciência da Computação' : 'N/A',
            orientador: 'Não definido',
            coorientador: 'Não definido',
