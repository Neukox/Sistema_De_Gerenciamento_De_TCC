  ...
  const cadastrarTCC = async (formData: CadastrarTCCForm) => {
    ...
    try {
      ...
      const tccData: CreateTCCRequest = {
        ...
        // Temporariamente usando IDs fixos até integrar com o backend
        // TODO: Implementar lógica para buscar/criar professores baseado nos nomes
        orientadorId: 1, // ID padrão para teste
        coorientadorId: formData.coorientador ? 2 : undefined, // ID padrão se coorientador for preenchido
      };
