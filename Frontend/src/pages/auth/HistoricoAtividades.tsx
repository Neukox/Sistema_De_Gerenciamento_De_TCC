export function HistoricoAtividades() {
  return (
    <div className="flex flex-col items-center justify-start h-[1500px] bg-historico px-6 py-8 gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M8 7V3m8 4V3M3 11h18M5 19h14a2 2 0 0 0 2-2v-5H3v5a2 2 0 0 0 2 2z"
              />
            </svg>
            <div className="flex flex-col">
              <h2 className="font-semibold text-gray-800">Reunião Agendada</h2>
              <p className="text-sm text-gray-600">Marcou reunião para 20/01/2024 às 10h</p>
              <p className="text-sm text-gray-600">10/01/2024, 09:30</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <svg
      ...
      {/* Resumo Geral (4 blocos) COM MARGEM vertical para não colar no fundo */}
