  ...
  function MainDashboard() {
    ...
    return (
      <div className="flex flex-col items-center bg-[#F3C50D] h-screen w-screen pt-6">
        {/* Title and info container for the dashboard */}
        <div className="w-[90%] h-[40%] bg-[#fffbef] flex flex-col rounded-lg shadow-lg p-6 pt-1 px-auto">
        ...
        {/* Boxs progress*/}
          <div className='flex flex-row items-center justify-between w-[90%] min-h-40  mt-4 gap-5 '>
        ...
        {/* Bar*/}
          <div className=' flex flex-row items-center text-2xl gap-28 pl-8 bg-[#fffbef] w-[90%] min-h-20 mt-4 rounded-sm shadow-lg'>            
            
            
            <span className='flex items-center gap-2 font-medium text-[#7c7d80] cursor-pointer '> <LuTarget />Marcos</span>
            <span className='flex items-center gap-2 font-medium text-[#7c7d80] cursor-pointer '> <GrTask />Tarefas</span>
            <span className='flex items-center gap-2 font-medium text-[#7c7d80] cursor-pointer '><IoCalendarClearOutline />Anotações</span>
